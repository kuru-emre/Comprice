    ...
    <>
      <section className="relative isolate overflow-hidden">
        <Image
          ...
          alt="Hero image"
          fill={true}
          sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 75vw"
          priority={true}
          quality={60}
        ...
        <div className="mx-auto max-w-7xl flex h-screen justify-center items-center">
          <div className="text-center">
            <h1 className="text-main font-lastica text-3xl font-light tracking-widest lg:text-5xl">{t('title')}</h1>
            <p className="text-accent mt-6 text-md px-8 lg:text-lg leading-8">{t('subTitle')}</p>
      ...
      <section className="bg-main py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-7xl lg:text-center">
            <h2 className="text-main mt-2 font-lastica text-2xl font-normal tracking-widest lg:text-4xl">{t('section_1.title')}</h2>
            <p className="text-accent mt-4 text-lg leading-8">{t('section_1.subTitle')}</p>
          </div>
      ...
      <section className="bg-main overflow-hidden py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="text-main mt-2 font-lastica text-2xl font-normal tracking-widest sm:text-4xl">{t('section_2.title')}</h2>
                <p className="text-accent mt-4 text-lg leading-8">{t('section_2.subTitle')}</p>
