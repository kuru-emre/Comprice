...
export default function MainPage() {
  return (
    <>
      <section className="relative isolate overflow-hidden pt-14">
        ...
        <div className="mx-auto max-w-5xl px-2 py-32 sm:py-48 lg:py-60">
          <div className="text-center">
            <h1 className="text-main font-lastica text-4xl font-light tracking-widest sm:text-6xl lg:text-5xl">Simplifying B2B Trade</h1>
      ...
      <section className="bg-main bg-base overflow-hidden py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
