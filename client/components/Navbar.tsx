...
export default function Navbar() {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-30 flex justify-center">
      <motion.nav style={transforms} className="fixed flex items-center justify-between p-6 drop-shadow-xl transition-all duration-500 lg:px-8" aria-label="Global">
